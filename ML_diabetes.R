...
ggplot(data) +
  ...
  geom_boxplot() +
  theme(axis.text.x = element_text(angle = 90))
# BMI is higher in the group of people who have diabetes. BMI less than 18.5 is underweight, 18.5-24.9 is normal, 
# 25-29.9 is overweight, and 30 or more is obese. Majority of people have overweight according to BMI norms.
...
# Before sampling - Decision tree with cross validation and Random Forest with cross validation have better diabetes prediction results 
# comparing to logistic regression and Bayes classifier.

# After RUS&ROS sampling - all ML models showed decrease in accuracy, despite Decision Tree.

# Based on results, for this data for more accurate prediction of diabetes risk it is recommended to use 
# Decision Tree algorithm with sampling or Decision Tree or Random Forest methods with cross validation without sampling.
